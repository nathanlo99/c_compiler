...
struct ASTRecursiveVisitor {
  ...
  virtual void pre_visit(ForStatement &) {}
  virtual void pre_visit(PrintStatement &) {}
  virtual void pre_visit(DeleteStatement &) {}
  virtual void pre_visit(BreakStatement &) {}
  virtual void pre_visit(ContinueStatement &) {}
  virtual void pre_visit(ReturnStatement &) {}
